 ...
 *
 * @method     ChildMenuLink|null findOne(ConnectionInterface $con = null) Return the first ChildMenuLink matching the query
 ...
 *
 * @method     ChildMenuLink|null findOneById(int $linkId) Return the first ChildMenuLink filtered by the linkId column
 * @method     ChildMenuLink|null findOneByName(string $linkName) Return the first ChildMenuLink filtered by the linkName column
 * @method     ChildMenuLink|null findOneByUri(string $linkUri) Return the first ChildMenuLink filtered by the linkUri column
 * @method     ChildMenuLink|null findOneByOrder(int $linkOrder) Return the first ChildMenuLink filtered by the linkOrder column *
