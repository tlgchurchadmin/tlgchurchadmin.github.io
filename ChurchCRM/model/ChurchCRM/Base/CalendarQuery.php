 ...
 *
 * @method     ChildCalendar|null findOneById(int $calendar_id) Return the first ChildCalendar filtered by the calendar_id column
 * @method     ChildCalendar|null findOneByName(string $name) Return the first ChildCalendar filtered by the name column
 * @method     ChildCalendar|null findOneByAccessToken(string $accesstoken) Return the first ChildCalendar filtered by the accesstoken column
 * @method     ChildCalendar|null findOneByBackgroundColor(string $backgroundColor) Return the first ChildCalendar filtered by the backgroundColor column
 * @method     ChildCalendar|null findOneByForegroundColor(string $foregroundColor) Return the first ChildCalendar filtered by the foregroundColor column *
