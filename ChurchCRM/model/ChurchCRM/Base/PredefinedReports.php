...
use \Exception;
use \PDO;
use ChurchCRM\PredefinedReportsQuery as ChildPredefinedReportsQuery;
use ChurchCRM\Map\PredefinedReportsTableMap;
...
abstract class PredefinedReports implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\PredefinedReportsTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\PredefinedReports object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ChurchCRM\PredefinedReports The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\PredefinedReports'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\PredefinedReports
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\PredefinedReports The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\PredefinedReports (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\PredefinedReports Clone of current object.
     * @throws PropelException
     */
