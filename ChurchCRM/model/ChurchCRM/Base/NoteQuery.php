 ...
 *
 * @method     ChildNote|null findOneById(int $nte_ID) Return the first ChildNote filtered by the nte_ID column
 * @method     ChildNote|null findOneByPerId(int $nte_per_ID) Return the first ChildNote filtered by the nte_per_ID column
 * @method     ChildNote|null findOneByFamId(int $nte_fam_ID) Return the first ChildNote filtered by the nte_fam_ID column
 * @method     ChildNote|null findOneByPrivate(int $nte_Private) Return the first ChildNote filtered by the nte_Private column
 * @method     ChildNote|null findOneByText(string $nte_Text) Return the first ChildNote filtered by the nte_Text column
 * @method     ChildNote|null findOneByDateEntered(string $nte_DateEntered) Return the first ChildNote filtered by the nte_DateEntered column
 * @method     ChildNote|null findOneByDateLastEdited(string $nte_DateLastEdited) Return the first ChildNote filtered by the nte_DateLastEdited column
 * @method     ChildNote|null findOneByEnteredBy(int $nte_EnteredBy) Return the first ChildNote filtered by the nte_EnteredBy column
 * @method     ChildNote|null findOneByEditedBy(int $nte_EditedBy) Return the first ChildNote filtered by the nte_EditedBy column
 * @method     ChildNote|null findOneByType(string $nte_Type) Return the first ChildNote filtered by the nte_Type column *
