 ...
 *
 * @method     ChildRecordProperty|null findOne(ConnectionInterface $con = null) Return the first ChildRecordProperty matching the query
 ...
 *
 * @method     ChildRecordProperty|null findOneByPropertyId(int $r2p_pro_ID) Return the first ChildRecordProperty filtered by the r2p_pro_ID column
 * @method     ChildRecordProperty|null findOneByRecordId(int $r2p_record_ID) Return the first ChildRecordProperty filtered by the r2p_record_ID column
 * @method     ChildRecordProperty|null findOneByPropertyValue(string $r2p_Value) Return the first ChildRecordProperty filtered by the r2p_Value column *
