 ...
 *
 * @method     ChildWhyCame|null findOne(ConnectionInterface $con = null) Return the first ChildWhyCame matching the query
 ...
 *
 * @method     ChildWhyCame|null findOneById(int $why_ID) Return the first ChildWhyCame filtered by the why_ID column
 * @method     ChildWhyCame|null findOneByPerId(int $why_per_ID) Return the first ChildWhyCame filtered by the why_per_ID column
 * @method     ChildWhyCame|null findOneByJoin(string $why_join) Return the first ChildWhyCame filtered by the why_join column
 * @method     ChildWhyCame|null findOneByCome(string $why_come) Return the first ChildWhyCame filtered by the why_come column
 * @method     ChildWhyCame|null findOneBySuggest(string $why_suggest) Return the first ChildWhyCame filtered by the why_suggest column
 * @method     ChildWhyCame|null findOneByHearOfUs(string $why_hearOfUs) Return the first ChildWhyCame filtered by the why_hearOfUs column *
