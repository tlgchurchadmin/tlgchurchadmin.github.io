 ...
 * @method     ChildToken|null findOneByType(string $type) Return the first ChildToken filtered by the type column
 * @method     ChildToken|null findOneByValidUntilDate(string $valid_until_date) Return the first ChildToken filtered by the valid_until_date column
 * @method     ChildToken|null findOneByReferenceId(int $reference_id) Return the first ChildToken filtered by the reference_id column
 * @method     ChildToken|null findOneByRemainingUses(int $remainingUses) Return the first ChildToken filtered by the remainingUses column *
