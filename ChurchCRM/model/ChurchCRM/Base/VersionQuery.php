 ...
 *
 * @method     ChildVersion|null findOne(ConnectionInterface $con = null) Return the first ChildVersion matching the query
 ...
 *
 * @method     ChildVersion|null findOneById(int $ver_ID) Return the first ChildVersion filtered by the ver_ID column
 * @method     ChildVersion|null findOneByVersion(string $ver_version) Return the first ChildVersion filtered by the ver_version column
 * @method     ChildVersion|null findOneByUpdateStart(string $ver_update_start) Return the first ChildVersion filtered by the ver_update_start column
 * @method     ChildVersion|null findOneByUpdateEnd(string $ver_update_end) Return the first ChildVersion filtered by the ver_update_end column *
