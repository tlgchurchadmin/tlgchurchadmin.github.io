 ...
 *
 * @method     ChildEventAudience|null findOne(ConnectionInterface $con = null) Return the first ChildEventAudience matching the query
 ...
 *
 * @method     ChildEventAudience|null findOneByEventId(int $event_id) Return the first ChildEventAudience filtered by the event_id column
 * @method     ChildEventAudience|null findOneByGroupId(int $group_id) Return the first ChildEventAudience filtered by the group_id column *
