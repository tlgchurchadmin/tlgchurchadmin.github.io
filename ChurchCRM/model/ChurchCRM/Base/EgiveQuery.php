 ...
 *
 * @method     ChildEgive|null findOne(ConnectionInterface $con = null) Return the first ChildEgive matching the query
 ...
 *
 * @method     ChildEgive|null findOneByEgiveId(string $egv_egiveID) Return the first ChildEgive filtered by the egv_egiveID column
 * @method     ChildEgive|null findOneByFamilyId(int $egv_famID) Return the first ChildEgive filtered by the egv_famID column
 * @method     ChildEgive|null findOneByDateEntered(string $egv_DateEntered) Return the first ChildEgive filtered by the egv_DateEntered column
 * @method     ChildEgive|null findOneByDateLastEdited(string $egv_DateLastEdited) Return the first ChildEgive filtered by the egv_DateLastEdited column
 * @method     ChildEgive|null findOneByEnteredBy(int $egv_EnteredBy) Return the first ChildEgive filtered by the egv_EnteredBy column
 * @method     ChildEgive|null findOneByEditedBy(int $egv_EditedBy) Return the first ChildEgive filtered by the egv_EditedBy column *
