 ...
 *
 * @method     ChildUserConfig|null findOne(ConnectionInterface $con = null) Return the first ChildUserConfig matching the query
 ...
 *
 * @method     ChildUserConfig|null findOneByPeronId(int $ucfg_per_id) Return the first ChildUserConfig filtered by the ucfg_per_id column
 * @method     ChildUserConfig|null findOneById(int $ucfg_id) Return the first ChildUserConfig filtered by the ucfg_id column
 * @method     ChildUserConfig|null findOneByName(string $ucfg_name) Return the first ChildUserConfig filtered by the ucfg_name column
 * @method     ChildUserConfig|null findOneByValue(string $ucfg_value) Return the first ChildUserConfig filtered by the ucfg_value column
 * @method     ChildUserConfig|null findOneByType(string $ucfg_type) Return the first ChildUserConfig filtered by the ucfg_type column
 * @method     ChildUserConfig|null findOneByTooltip(string $ucfg_tooltip) Return the first ChildUserConfig filtered by the ucfg_tooltip column
 * @method     ChildUserConfig|null findOneByPermission(string $ucfg_permission) Return the first ChildUserConfig filtered by the ucfg_permission column
 * @method     ChildUserConfig|null findOneByCat(string $ucfg_cat) Return the first ChildUserConfig filtered by the ucfg_cat column *
