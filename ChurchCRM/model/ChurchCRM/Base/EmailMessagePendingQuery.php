 ...
 *
 * @method     ChildEmailMessagePending|null findOne(ConnectionInterface $con = null) Return the first ChildEmailMessagePending matching the query
 ...
 *
 * @method     ChildEmailMessagePending|null findOneByUsrId(int $emp_usr_id) Return the first ChildEmailMessagePending filtered by the emp_usr_id column
 * @method     ChildEmailMessagePending|null findOneByToSend(int $emp_to_send) Return the first ChildEmailMessagePending filtered by the emp_to_send column
 * @method     ChildEmailMessagePending|null findOneBySubject(string $emp_subject) Return the first ChildEmailMessagePending filtered by the emp_subject column
 * @method     ChildEmailMessagePending|null findOneByMessage(string $emp_message) Return the first ChildEmailMessagePending filtered by the emp_message column
 * @method     ChildEmailMessagePending|null findOneByAttachName(string $emp_attach_name) Return the first ChildEmailMessagePending filtered by the emp_attach_name column
 * @method     ChildEmailMessagePending|null findOneByAttach(boolean $emp_attach) Return the first ChildEmailMessagePending filtered by the emp_attach column *
