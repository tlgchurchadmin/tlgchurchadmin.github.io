 ...
 *
 * @method     ChildUserSetting|null findOne(ConnectionInterface $con = null) Return the first ChildUserSetting matching the query
 ...
 *
 * @method     ChildUserSetting|null findOneByUserId(int $user_id) Return the first ChildUserSetting filtered by the user_id column
 * @method     ChildUserSetting|null findOneByName(string $setting_name) Return the first ChildUserSetting filtered by the setting_name column
 * @method     ChildUserSetting|null findOneByValue(string $setting_value) Return the first ChildUserSetting filtered by the setting_value column *
