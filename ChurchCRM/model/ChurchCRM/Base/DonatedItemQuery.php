 ...
 *
 * @method     ChildDonatedItem|null findOne(ConnectionInterface $con = null) Return the first ChildDonatedItem matching the query
 ...
 *
 * @method     ChildDonatedItem|null findOneById(int $di_ID) Return the first ChildDonatedItem filtered by the di_ID column
 * @method     ChildDonatedItem|null findOneByItem(string $di_item) Return the first ChildDonatedItem filtered by the di_item column
 * @method     ChildDonatedItem|null findOneByFrId(int $di_FR_ID) Return the first ChildDonatedItem filtered by the di_FR_ID column
 * @method     ChildDonatedItem|null findOneByDonorId(int $di_donor_ID) Return the first ChildDonatedItem filtered by the di_donor_ID column
 * @method     ChildDonatedItem|null findOneByBuyerId(int $di_buyer_ID) Return the first ChildDonatedItem filtered by the di_buyer_ID column
 * @method     ChildDonatedItem|null findOneByMultibuy(int $di_multibuy) Return the first ChildDonatedItem filtered by the di_multibuy column
 * @method     ChildDonatedItem|null findOneByTitle(string $di_title) Return the first ChildDonatedItem filtered by the di_title column
 * @method     ChildDonatedItem|null findOneByDescription(string $di_description) Return the first ChildDonatedItem filtered by the di_description column
 * @method     ChildDonatedItem|null findOneBySellprice(string $di_sellprice) Return the first ChildDonatedItem filtered by the di_sellprice column
 * @method     ChildDonatedItem|null findOneByEstprice(string $di_estprice) Return the first ChildDonatedItem filtered by the di_estprice column
 * @method     ChildDonatedItem|null findOneByMinimum(string $di_minimum) Return the first ChildDonatedItem filtered by the di_minimum column
 * @method     ChildDonatedItem|null findOneByMaterialValue(string $di_materialvalue) Return the first ChildDonatedItem filtered by the di_materialvalue column
 * @method     ChildDonatedItem|null findOneByEnteredby(int $di_EnteredBy) Return the first ChildDonatedItem filtered by the di_EnteredBy column
 * @method     ChildDonatedItem|null findOneByEntereddate(string $di_EnteredDate) Return the first ChildDonatedItem filtered by the di_EnteredDate column
 * @method     ChildDonatedItem|null findOneByPicture(string $di_picture) Return the first ChildDonatedItem filtered by the di_picture column *
