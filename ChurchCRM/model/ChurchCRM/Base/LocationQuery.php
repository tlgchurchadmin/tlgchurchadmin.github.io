 ...
 *
 * @method     ChildLocation|null findOneByLocationId(int $location_id) Return the first ChildLocation filtered by the location_id column
 * @method     ChildLocation|null findOneByLocationType(int $location_typeID) Return the first ChildLocation filtered by the location_typeID column
 * @method     ChildLocation|null findOneByLocationName(string $location_name) Return the first ChildLocation filtered by the location_name column
 * @method     ChildLocation|null findOneByLocationAddress(string $location_address) Return the first ChildLocation filtered by the location_address column
 * @method     ChildLocation|null findOneByLocationCity(string $location_city) Return the first ChildLocation filtered by the location_city column
 * @method     ChildLocation|null findOneByLocationState(string $location_state) Return the first ChildLocation filtered by the location_state column
 * @method     ChildLocation|null findOneByLocationZip(string $location_zip) Return the first ChildLocation filtered by the location_zip column
 * @method     ChildLocation|null findOneByLocationCountry(string $location_country) Return the first ChildLocation filtered by the location_country column
 * @method     ChildLocation|null findOneByLocationPhone(string $location_phone) Return the first ChildLocation filtered by the location_phone column
 * @method     ChildLocation|null findOneByLocationEmail(string $location_email) Return the first ChildLocation filtered by the location_email column
 * @method     ChildLocation|null findOneByLocationTimzezone(string $location_timzezone) Return the first ChildLocation filtered by the location_timzezone column *
