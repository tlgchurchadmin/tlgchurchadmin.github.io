...
class EmailRecipientPendingTableMap extends TableMap
{
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Id' => 'ERP_ID',
        'EmailRecipientPending.Id' => 'ERP_ID',
        'id' => 'ERP_ID',
        'emailRecipientPending.id' => 'ERP_ID',
        'EmailRecipientPendingTableMap::COL_ERP_ID' => 'ERP_ID',
        'COL_ERP_ID' => 'ERP_ID',
        'erp_id' => 'ERP_ID',
        'email_recipient_pending_erp.erp_id' => 'ERP_ID',
        'UsrId' => 'ERP_USR_ID',
        'EmailRecipientPending.UsrId' => 'ERP_USR_ID',
        'usrId' => 'ERP_USR_ID',
        'emailRecipientPending.usrId' => 'ERP_USR_ID',
        'EmailRecipientPendingTableMap::COL_ERP_USR_ID' => 'ERP_USR_ID',
        'COL_ERP_USR_ID' => 'ERP_USR_ID',
        'erp_usr_id' => 'ERP_USR_ID',
        'email_recipient_pending_erp.erp_usr_id' => 'ERP_USR_ID',
        'NumAttempt' => 'ERP_NUM_ATTEMPT',
        'EmailRecipientPending.NumAttempt' => 'ERP_NUM_ATTEMPT',
        'numAttempt' => 'ERP_NUM_ATTEMPT',
        'emailRecipientPending.numAttempt' => 'ERP_NUM_ATTEMPT',
        'EmailRecipientPendingTableMap::COL_ERP_NUM_ATTEMPT' => 'ERP_NUM_ATTEMPT',
        'COL_ERP_NUM_ATTEMPT' => 'ERP_NUM_ATTEMPT',
        'erp_num_attempt' => 'ERP_NUM_ATTEMPT',
        'email_recipient_pending_erp.erp_num_attempt' => 'ERP_NUM_ATTEMPT',
        'FailedTime' => 'ERP_FAILED_TIME',
        'EmailRecipientPending.FailedTime' => 'ERP_FAILED_TIME',
        'failedTime' => 'ERP_FAILED_TIME',
        'emailRecipientPending.failedTime' => 'ERP_FAILED_TIME',
        'EmailRecipientPendingTableMap::COL_ERP_FAILED_TIME' => 'ERP_FAILED_TIME',
        'COL_ERP_FAILED_TIME' => 'ERP_FAILED_TIME',
        'erp_failed_time' => 'ERP_FAILED_TIME',
        'email_recipient_pending_erp.erp_failed_time' => 'ERP_FAILED_TIME',
        'EmailAddress' => 'ERP_EMAIL_ADDRESS',
        'EmailRecipientPending.EmailAddress' => 'ERP_EMAIL_ADDRESS',
        'emailAddress' => 'ERP_EMAIL_ADDRESS',
        'emailRecipientPending.emailAddress' => 'ERP_EMAIL_ADDRESS',
        'EmailRecipientPendingTableMap::COL_ERP_EMAIL_ADDRESS' => 'ERP_EMAIL_ADDRESS',
        'COL_ERP_EMAIL_ADDRESS' => 'ERP_EMAIL_ADDRESS',
        'erp_email_address' => 'ERP_EMAIL_ADDRESS',
        'email_recipient_pending_erp.erp_email_address' => 'ERP_EMAIL_ADDRESS',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(EmailRecipientPendingTableMap::COL_ERP_ID);
            $criteria->removeSelectColumn(EmailRecipientPendingTableMap::COL_ERP_USR_ID);
            $criteria->removeSelectColumn(EmailRecipientPendingTableMap::COL_ERP_NUM_ATTEMPT);
            $criteria->removeSelectColumn(EmailRecipientPendingTableMap::COL_ERP_FAILED_TIME);
            $criteria->removeSelectColumn(EmailRecipientPendingTableMap::COL_ERP_EMAIL_ADDRESS);
        } else {
            $criteria->removeSelectColumn($alias . '.erp_id');
            $criteria->removeSelectColumn($alias . '.erp_usr_id');
            $criteria->removeSelectColumn($alias . '.erp_num_attempt');
            $criteria->removeSelectColumn($alias . '.erp_failed_time');
            $criteria->removeSelectColumn($alias . '.erp_email_address');
        }
    }
