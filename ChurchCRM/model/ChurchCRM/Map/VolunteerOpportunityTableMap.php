...
use ChurchCRM\VolunteerOpportunity;
use ChurchCRM\VolunteerOpportunityQuery;
...
class VolunteerOpportunityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.VolunteerOpportunityTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\VolunteerOpportunity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.VolunteerOpportunity';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\VolunteerOpportunity');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\VolunteerOpportunity) { // it's a model object
